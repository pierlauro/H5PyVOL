...
#### Miscellaneous
- In the [object-stores](https://github.com/pierlauro/H5PyVOL/tree/master/object-stores) folder it is possible to find example apps (GET/PUT/FILTERING etc...) and - in the subfolders - basic connectors for dataClay, Ceph Rados, Minio, OpenIO (same interface than Minio) and Swift.
